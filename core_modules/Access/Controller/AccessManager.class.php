...
// TODO: handle broken pages differently
    ...
    private function modifyUser()
    {
        ...
        if (isset($_POST['access_save_user'])) {
            ...
            if (((isset($_POST['notification_email']) && $_POST['notification_email'] == 1 && empty($cssDisplayStatusCreate)) || $objUser->setPassword(isset($_POST['access_user_password']) ? trim(contrexx_stripslashes($_POST['access_user_password'])) : '', isset($_POST['access_user_password_confirmed']) ? trim(contrexx_stripslashes($_POST['access_user_password_confirmed'])) : '')) &&
