...
class AccessLib
{
    ...
    private function loadAttributeTypeTemplates()
    {
        ...
        $this->arrAttributeTypeTemplates = array(
            ...
            'password'        => '<input type="text" value="" onkeyup="if (this.value == \'\') { this.setAttribute(\'type\', \'text\'); } else { this.setAttribute(\'type\', \'password\'); }" style="text-security: disc; -webkit-text-security: disc;" />',
