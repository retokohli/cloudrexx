    ...
    */
    ...
    function _placeholders()
    {
        ...
        $this->_objTpl->setVariable(array(
            ...
            'TXT_NEWS_COMMENT_BLOCK_CONTACT_FORM_CAPTCHA_DESCRIPTION'   => $_ARRAYLANG['TXT_NEWS_COMMENT_BLOCK_CONTACT_FORM_CAPTCHA_DESCRIPTION'],
            'TXT_NEWS_COMMENT_BLOCK_CONTACT_FORM_CAPTCHA_PATH'          => $_ARRAYLANG['TXT_NEWS_COMMENT_BLOCK_CONTACT_FORM_CAPTCHA_PATH'],
            'TXT_NEWS_COMMENT_BLOCK_CONTACT_FORM_CAPTCHA_ALT'           => $_ARRAYLANG['TXT_NEWS_COMMENT_BLOCK_CONTACT_FORM_CAPTCHA_ALT'],
