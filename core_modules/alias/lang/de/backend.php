...
$_ARRAYLANG['TXT_ALIAS_REQUIREMENTS_DESC'] = "Die Alias Verwaltung funktioniert nur mit einem <strong>Apache</strong> Webserver, welcher die Erweiterung <strong>mod_rewrite</strong> aktiviert hat.<br />Zusätzlich muss noch die Verwendung von <strong>.htaccess</strong> Dateien vom Server her erlaubt sein.";
...
$_ARRAYLANG['TXT_ALIAS_MOD_REWRITE_MISSING'] = "Es konnte nicht ermittelt werden ob auf diesem Server die Erweiterung <strong>mod_rewrite</strong> aktiv ist. Aus Risikogründen kann daher die Alias Verwaltung nicht aktiviert werden, da ansonsten die Webseite nicht mehr erreichbar wäre, wenn die Erweiterung <strong>mod_rewrite</strong> auf diesem Server fehlen würde.<br /><br />Wenn Sie aber sicher sind, dass auf diesem Server die Erweiterung <strong>mod_rewrite</strong> zur Verfügung steht, können Sie die Alias Verwaltung manuell aktivieren, indem Sie im Hauptverzeichnis dieser Webseite eine Datei mit dem Namen <strong>.htaccess</strong> anlegen und den folgenden Inhalt einfügen:<br /><code>RewriteEngine On</code><br />Das nächste Mal, wenn Sie sich dann in die Alias Verwaltung begeben, wird diese automatisch aktiviert.";
