...
$_ARRAYLANG['TXT_CORE_MODULE_MULTISITE_REMOTE_LOGIN_SUCCESS'] = 'Successfully login to website: %s! <br />The Adminpanel opens in a new window. In case no new window has opened, <a href="#turorial" title="Tutorial">here</a> a tutorial about how to allow Popups in your browser.';
...
//update
$_ARRAYLANG['TXT_CORE_MODULE_MULTISITE_LOADING_SERVICE_SERVER_INFO'] = 'Fetching the Codebase and Websites from the service server';
$_ARRAYLANG['TXT_CORE_MODULE_MULTISITE_TRIGGERING_WEBSITE_UPDATE'] = 'Triggering the website update process';
$_ARRAYLANG['TXT_CORE_MODULE_MULTISITE_SERVICE_SERVER_CODEBASE_REQUEST_SUCCESS'] = 'Codebase and Websites are successfully fetched from the service server';
...
$_ARRAYLANG['TXT_CORE_MODULE_MULTISITE_CODEBASE_NOT_EXIST'] = 'Codebase not exists';
$_ARRAYLANG['TXT_CORE_MODULE_MULTISITE_WEBSITE_UPDATE_PROCESS_ERROR_MSG'] = 'Unable to trigger the website update process';
$_ARRAYLANG['TXT_CORE_MODULE_MULTISITE_GET_WEBSITE_UPDATE_DETAIL_ERROR_MSG'] = 'Unable to get the codebase and website details';
