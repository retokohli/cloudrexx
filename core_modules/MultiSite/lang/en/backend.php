...
$_ARRAYLANG['TXT_CORE_MODULE_MULTISITE_MARKETINGWEBSITEURL']='URL of Marketing Website';
$_ARRAYLANG['TXT_CORE_MODULE_MULTISITE_MARKETINGWEBSITEURL_TOOLTIP']='Set the URL where the <i>Marketing Website</i> of the MultiSite system is located. Invalid HTTP-Requests to this Contrexx installation will automatically be forwarded to the given URL.';
