...
class JsonMultiSite implements \Cx\Core\Json\JsonAdapter {
    ...
    public function getAccessableMethods() {
        ...
        return array(
            ...
            'getFtpAccounts'        => new \Cx\Core_Modules\Access\Model\Entity\Permission(array('http', 'https'), array('post'), false, array($this, 'auth')),
            ...
            'getMailServicePlans'   => new \Cx\Core_Modules\Access\Model\Entity\Permission(array($multiSiteProtocol), array('post'), false, array($this, 'checkPermission')),
        );  
    }
