...
$_ARRAYLANG['TXT_FILEBROWSER_MEDIA_3'] = "Medyaarşivi #3";
$_ARRAYLANG['TXT_FILEBROWSER_SHOP'] = "Shop(market)";
$_ARRAYLANG['TXT_FILEBROWSER_CREATE_DIRECTORY'] = "Yeni dizin";
$_ARRAYLANG['TXT_FILEBROWSER_UPLOAD_FILE'] = "Veri Yükle";
$_ARRAYLANG['TXT_FILEBROWSER_INVALID_CHARACTERS'] = "Geçersiz karekter bulundu";
$_ARRAYLANG['TXT_FILEBROWSER_UNABLE_TO_CREATE_FOLDER'] = "%s Dizini oluşturulamadı.";
$_ARRAYLANG['TXT_FILEBROWSER_DIRECTORY_SUCCESSFULLY_CREATED'] = "%s Dizini başarıyla oluşturuldu.";
$_ARRAYLANG['TXT_FILEBROWSER_THUMBNAIL_SUCCESSFULLY_CREATED'] = "%s için başarıyla Thumbnail oluşturuldu  .";
$_ARRAYLANG['TXT_FILEBROWSER_MEDIA_4'] = "Medyaarşivi #4";
