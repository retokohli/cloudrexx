...
class MediaManager extends MediaLibrary {
    ...
    var $iconWebPath;                      // icon webPath constant
    ...
    var $chmodFile         = 0644;         // chmod for files  0644
    var $thumbHeight       = 80;           // max height for thumbnail
    var $thumbQuality      = 80;           // max quality for thumbnail

    var $docRoot;                          // ASCMS_DOCUMENT_ROOT
    ...
    var $highlightCCColor  = '#ffe7e7';    // highlight color for cuted or copied media [#ffe7e7]

    var $tmpPath           = array();      // dir tree path
    var $tmpPathName       = array();      // dir tree path name

    var $_objImage;                        // object from ImageManager class
