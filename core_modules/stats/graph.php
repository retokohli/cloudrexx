...
{
    private $stats = '';
    private $graphWidth = 600;
    private $graphHeight = 250;
    private $graphBackgroundColor = 'white';
    private $graphChartType = 'bars';
    private $graphChartBackgroundColor = 'white';
    private $graphChartBorderColor = 'white';
    private $graphChartTitle = '';
    private $graphChartTitleSize = 10;
    private $graphArrBarColor = array('blue', 'red');
    private $graphArrBarBorderColor = array('blue', 'red');
    private $graphArrLegendText = array();
    private $graphLegendBackgroundColor = 'white';
    private $graphTitleAxisX = '';
    private $graphTitleAxisY = '';
    private $graphGridX = 10;
    private $graphGridY = 0;
    private $graphGridColor = 'silver';
    private $graphAxisXMaxStringSize = 4;
    private $graphAxisFontSize = 7;
    private $graphAxisTitleFontSize = 10;
    private $graphArrData = array();
    private $graphScaleMax = 10;
    private $graphMarginLeft = 20;
    private $graphMarginRight = 20;
    private $graphMarginTop = 20;
    private $graphMarginBottom = 20;
    private $graphFrame = false;
    private $graphColor = '#c8d7ee';
