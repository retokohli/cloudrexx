...
/*
 * is used for generating the filebrowser view. 
 * @author tobias.schmoker
 */
...
class FileBrowserController {
    ...
    function _getPath() {
        ...
        $path = $this->_mediaType != 'webpages' && array_key_exists($this->_mediaType, $this->mediaTypePaths) && isset($_SESSION['fileBrowser']['path'][$this->_mediaType]) ? $_SESSION['fileBrowser']['path'][$this->_mediaType] : "";
        ...
        if ($this->_mediaType != 'webpages' && array_key_exists($this->_mediaType, $this->mediaTypePaths)
        ) {
