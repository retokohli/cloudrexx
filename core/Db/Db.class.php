...
/**
 * Initialized database connection and its abstractions (AdoDB and Doctrine)
 */
class Db {
    protected $pdo = null;
     ...
     */
    public function adodbPdoConnectionFactory() {
        $obj = new \Cx\Core\Db\CustomAdodbPdo($this->getPdoConnection());
        return $obj;
    }
