 ...
 */
    ...
    function __construct($langId=null)
    {
        ...
        $sql =  "
            SELECT n.catid, n.parcat, n.catname, n.displayorder,
                   n.displaystatus, n.username,
                   FROM_UNIXTIME(n.changelog,'%d.%m.%Y %T') AS changelog,
                   n.cmd, n.lang, n.module, n.startdate, n.enddate, n.protected,
                   n.frontend_access_id, n.backend_access_id, a_s.url AS alias_url,
        ...
        if ($objResult) {
            while (!$objResult->EOF) {
                $this->node[$objResult->fields['catid']] = array(
                    ...
                    'alias' => $objResult->fields['alias_enable']
