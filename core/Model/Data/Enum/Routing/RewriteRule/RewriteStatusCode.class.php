...
namespace Cx\Core\Model\Data\Enum\Routing\RewriteRule;
 ...
 * @subpackage  core_model
 */
class RewriteStatusCode extends \Cx\Core\Model\Model\Entity\EnumType {
    
    /**
     * Sets the possible values for this ENUM type
     */
    protected $values = array('301', '302', 'intern');
}
