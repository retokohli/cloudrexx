...
namespace Cx\Core\Model\Data\Enum\View\Frontend;
 ...
 * @subpackage  core_model
 */
class Channel extends \Cx\Core\Model\Model\Entity\EnumType {
    
    /**
     * Sets the possible values for this ENUM type
     */
    protected $values = array('default', 'mobile', 'print', 'pdf', 'app');
}
