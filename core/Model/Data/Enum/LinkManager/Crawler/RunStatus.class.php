...
namespace Cx\Core\Model\Data\Enum\LinkManager\Crawler;
 ...
 * @subpackage  core_model
 */
class RunStatus extends \Cx\Core\Model\Model\Entity\EnumType {
    
    /**
     * Sets the possible values for this ENUM type
     */
    protected $values = array('running', 'incomplete', 'completed');
}
