...
namespace Cx\Core\Model\Data\Enum\Calendar\RegistrationFormField;
 ...
 * @subpackage  core_model
 */
class Type extends \Cx\Core\Model\Model\Entity\EnumType {
    
    /**
     * Sets the possible values for this ENUM type
     */
    protected $values = array('inputtext', 'textarea', 'select', 'radio', 'checkbox', 'mail', 'seating', 'agb', 'salutation', 'firstname', 'lastname', 'selectBillingAddress', 'fieldset');
}
