...
namespace Cx\Core\Model\Data\Enum\Calendar\Invite;
 ...
 * @subpackage  core_model
 */
class InviteeType extends \Cx\Core\Model\Model\Entity\EnumType {
    
    /**
     * Sets the possible values for this ENUM type
     */
    protected $values = array('-', 'AccessUser', 'CrmContact');
}
