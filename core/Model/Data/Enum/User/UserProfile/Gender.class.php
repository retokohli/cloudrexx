...
namespace Cx\Core\Model\Data\Enum\User\UserProfile;
 ...
 * @subpackage  core_model
 */
class Gender extends \Cx\Core\Model\Model\Entity\EnumType {
    
    /**
     * Sets the possible values for this ENUM type
     */
    protected $values = array('gender_undefined', 'gender_female', 'gender_male');
}
