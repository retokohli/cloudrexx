...
namespace Cx\Core\Model\Data\Enum\User\UserAttribute;
 ...
 * @subpackage  core_model
 */
class AccessSpecial extends \Cx\Core\Model\Model\Entity\EnumType {
    
    /**
     * Sets the possible values for this ENUM type
     */
    protected $values = array('', 'menu_select_higher', 'menu_select_lower');
}
