...
class ComponentController extends \Cx\Core\Core\Model\Entity\SystemComponentController {
    ...
    public function postResolve(\Cx\Core\ContentManager\Model\Entity\Page $page) {
        ...
        // candy. We're doing \Cx\Core\Csrf\Controller\ComponentController::check_code() in the relevant
    ...
    public function postContentLoad(\Cx\Core\ContentManager\Model\Entity\Page $page) {
        ...
        self::add_placeholder($objTemplate);
    ...
    {
        \DBG::msg('\Cx\Core\Csrf\Controller\ComponentController::header(): Set header "' . $header);
     ...
     * with \Cx\Core\Csrf\Controller\ComponentController::code()
     */
     ...
     * with \Cx\Core\Csrf\Controller\ComponentController::key()
     */
    ...
    private static function __kill()
    {
        ...
        self::add_code();
        $tpl = new \Cx\Core\Html\Sigma(ASCMS_CORE_PATH.'/Csrf/View/Template/Generic/');
...
ComponentController::cleanRequestURI();
