...
$_ARRAYLANG['TXT_CORE_CONFIG_XMLSITEMAPSTATUS_TOOLTIP_HELP'] = 'Generazione automatica di un account XML Sitemap - stato (on | off).';
...
$_ARRAYLANG['TXT_CORE_CONFIG_COREPAGINGLIMIT_TOOLTIP_HELP'] = 'Tra 1 e 200.';
$_ARRAYLANG['TXT_CORE_CONFIG_SEARCHDESCRIPTIONLENGTH'] = 'Caratteri visualizzati nei risultati di ricerca.';
...
$_ARRAYLANG['TXT_CORE_CONFIG_CONTACTFORMEMAIL'] = 'EMail-address for contactform (default)';
$_ARRAYLANG['TXT_CORE_CONFIG_CONTACTFORMEMAIL_TOOLTIP_HELP'] = 'The email-address of the receiver for the default-form (no id specified). Several adresses can be divided by comma.';
