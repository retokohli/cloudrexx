 ...
 */
class CxModelContentManagerPageProxy extends \Cx\Core\ContentManager\Model\Doctrine\Entity\Page implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function setSkin(\Cx\Core\ContentManager\Model\Doctrine\Entity\Skin $skin)
    {
        $this->_load();
