 ...
 */
class DoctrineRepository extends \Cx\Core\DataSource\Model\Entity\DoctrineRepository implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'supportedOperations', 'id', 'identifier', 'type', 'options', 'dataAccesses', 'validators', 'virtual');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DoctrineRepository $proxy) {
