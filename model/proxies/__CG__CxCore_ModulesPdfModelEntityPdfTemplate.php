...
namespace Cx\Model\Proxies\__CG__\Cx\Core_Modules\Pdf\Model\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class PdfTemplate extends \Cx\Core_Modules\Pdf\Model\Entity\PdfTemplate implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PdfTemplate $proxy) {
