 ...
 */
class CxModulesMediaDirModelEntityCategoryProxy extends \Cx\Modules\MediaDir\Model\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->_load();
        return parent::setShowSubcategories($showSubcategories);
    }

    public function getShowSubcategories()
    {
        $this->_load();
        return parent::getShowSubcategories();
    }
    ...
    {
        return array('__isInitialized__', 'id', 'order', 'show_subcategories', 'show_entries', 'picture', 'active', 'lft', 'rgt', 'lvl', 'children', 'locale', 'parent');
    }
