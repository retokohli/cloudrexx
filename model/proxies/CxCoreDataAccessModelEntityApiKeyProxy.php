 ...
 */
class CxCoreDataAccessModelEntityApiKeyProxy extends \Cx\Core\DataAccess\Model\Entity\ApiKey implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'apiKey', 'dataAccessApiKeys');
    }
