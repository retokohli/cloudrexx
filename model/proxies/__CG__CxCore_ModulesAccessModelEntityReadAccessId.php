 ...
 */
class ReadAccessId extends \Cx\Core_Modules\Access\Model\Entity\ReadAccessId implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Cx\\Core_Modules\\Access\\Model\\Entity\\ReadAccessId' . "\0" . 'id', '' . "\0" . 'Cx\\Core_Modules\\Access\\Model\\Entity\\ReadAccessId' . "\0" . 'entity_class_name', '' . "\0" . 'Cx\\Core_Modules\\Access\\Model\\Entity\\ReadAccessId' . "\0" . 'entity_class_id', '' . "\0" . 'Cx\\Core_Modules\\Access\\Model\\Entity\\ReadAccessId' . "\0" . 'contrexxAccessUserAttribute', '' . "\0" . 'Cx\\Core_Modules\\Access\\Model\\Entity\\ReadAccessId' . "\0" . 'coreAttribute', '' . "\0" . 'Cx\\Core_Modules\\Access\\Model\\Entity\\ReadAccessId' . "\0" . 'group2', '' . "\0" . 'Cx\\Core_Modules\\Access\\Model\\Entity\\ReadAccessId' . "\0" . 'group', 'validators', 'virtual');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ReadAccessId $proxy) {
