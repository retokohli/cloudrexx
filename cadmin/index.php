 ...
 *
 * Use the LANG_ID, FRONTEND_LANG_ID, and BACKEND_LANG_ID
 * global constants instead.
 */
$_BACKEND_LANGID = BACKEND_LANG_ID;
$_FRONTEND_LANGID = FRONTEND_LANG_ID;
$_LANGID = BACKEND_LANG_ID;
...
define('MODULE_ACCESS_ID_OFFSET', intval(MODULE_INDEX)*1000);
...
switch ($plainCmd) {
    ...
    //-------------------------------------------------------
    case 'shop':
        Permission::checkAccess(MODULE_ACCESS_ID_OFFSET+13, 'static');
