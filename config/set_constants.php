...
define('ASCMS_ADMIN_PATH',	                ASCMS_DOCUMENT_ROOT.'/admin');
define('ASCMS_ADMIN_WEB_PATH',	            ASCMS_PATH_OFFSET.'/admin');
define('ASCMS_ADMIN_TEMPLATE_PATH',	        ASCMS_DOCUMENT_ROOT.'/admin/template/ascms');
define('ASCMS_ADMIN_TEMPLATE_WEB_PATH',     ASCMS_PATH_OFFSET.'/admin/template/ascms');
define('ASCMS_API_PATH',	                ASCMS_DOCUMENT_ROOT.'/core/API');
define('ASCMS_FRAMEWORK_PATH',	            ASCMS_DOCUMENT_ROOT.'/lib/FRAMEWORK');
define('ASCMS_BACKUP_PATH',	                ASCMS_DOCUMENT_ROOT.'/admin/backup');
define('ASCMS_BACKUP_WEB_PATH',	            ASCMS_PATH_OFFSET.'/admin/backup');
