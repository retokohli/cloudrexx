...
class CheckoutManager extends CheckoutLibrary {
    ...
    private function showSettingsMails()
    {
        ...
        $this->objTemplate->setVariable(array(
            ...
            'CHECKOUT_ADMIN_MAIL_CONTENT'                       => new \Cx\Core\Wysiwyg('adminMail[content]', $arrAdminMail['content']),
            'CHECKOUT_CUSTOMER_MAIL_TITLE'                      => $arrCustomerMail['title'],
            'CHECKOUT_CUSTOMER_MAIL_CONTENT'                    => new \Cx\Core\Wysiwyg('customerMail[content]', $arrCustomerMail['content']),
            'TXT_CORE_SAVE'                                     => $_CORELANG['TXT_SAVE'],
