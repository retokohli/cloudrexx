...
class Saferpay
{
	...
	*/
	...
	/**
	* Needed keys for the respective operation
	* @access private
	* @var array
	*/
	var $arrKeys = array(
	...
	*/
	function getAttributeList($step)
	{
		...
		foreach ($this->arrShopOrder as $attribute => $value)
		{
			if ($this->checkAttribute($attribute)) {
				$this->addAttribute($attribute);
			}
	...
	*
	* Checks if the given attribute exists in the array arrShopOrder.
	*
	* @access private
	...
	* Checks an attribute
	*
	* Checks the value of an attribute for correctness.
	*
	* @access private
...
// $arrProviders may be undefined!
	...
	*
	* It also deletes the attribute from the attribute-array arrShopOrder.
	*
	* @access private
