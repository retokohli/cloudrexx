...
class RecommendManager extends RecommendLibrary
{
    ...
    function _showSettings()
    {
        ...
        $sal_female = $this->getFemaleSalutation(FRONTEND_LANG_ID);
        $sal_male     = $this->getMaleSalutation(FRONTEND_LANG_ID);
    ...
    function _saveValue($name, $value)
    {
        ...
        $query = "
            SELECT *
              FROM ".DBPREFIX."module_recommend
             WHERE name='$name'
        ...
        if ($objResult->RecordCount() > 0 ) {
            ...
            $query = "
                UPDATE ".DBPREFIX."module_recommend
            ...
            $query = "
                INSERT INTO ".DBPREFIX."module_recommend (
                    name, value, lang_id
                ) VALUES (
                    '$name', '".addslashes($value)."', '".FRONTEND_LANG_ID."
                )";
        }
