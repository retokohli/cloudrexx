...
class ecard
{
    ...
    function settings()
    {
        ...
        $this->_objTpl->setVariable(array(
            ...
            'TXT_REPLACE_SALUTATION_RECIPIENT' => $_ARRAYLANG['TXT_REPLACE_SALUTATION_RECIPIENT'],
            'TXT_REPLACE_NAME_RECIPIENT' => $_ARRAYLANG['TXT_REPLACE_NAME_RECIPIENT'],
            'TXT_REPLACE_EMAIL_RECIPIENT' => $_ARRAYLANG['TXT_REPLACE_EMAIL_RECIPIENT'],
