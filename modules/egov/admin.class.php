...
// Remove when the whole module is migrated.
    ...
    function _product_edit()
    {
        ...
        $this->objTemplate->setVariable(array(
            ...
            'PRODUCT_FORM_DESC' => new \Cx\Core\Wysiwyg('contactFormDesc', eGovLibrary::GetProduktValue("product_desc", $product_id), 'shop'),
            ...
            'PRODUCT_FORM_TARGET_MESSAGE' => new \Cx\Core\Wysiwyg('productFormTargetMessage', eGovLibrary::GetProduktValue("product_message", $product_id), 'shop'),
