...
function getInputfield($intView, $arrInputfield, $intEntryId=null)
    {
        ...
        if($objInit->mode == 'backend') {
                    $strInputfield =
                        $strImagePreview.'<input type="text" name="'.$this->moduleNameLC.'Inputfield['.$intId.']"'.
                    ...
                    $strInputfield =
                        ...
                        ' id="'.$this->moduleNameLC.'Inputfield_'.$intId.'"'.
...
//                        $strInfoValue.
                        ...
                        '<input id="'.$this->moduleNameLC.'Inputfield_'.$intId.'_hidden"'.
                        ' name="'.$this->moduleNameLC.'Inputfield['.$intId.']"'.
