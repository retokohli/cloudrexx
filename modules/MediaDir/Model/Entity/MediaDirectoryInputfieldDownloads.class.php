    ...
    function getInputfield($intView, $arrInputfield, $intEntryId=null)
    {
        ...
        switch ($intView) {
            ...
            case 1:
                ...
                if($objInit->mode == 'backend') {
                    $strBlankElement .= '<input type="text" name="'.$this->moduleNameLC.'Inputfield['.$intId.'][0][ELEMENT-KEY][file]" id="'.$this->moduleNameLC.'Inputfield_'.$intId.'_ELEMENT-KEY_0_file" style="width: 213px;" onfocus="this.select();" />&nbsp;<input type="button" value="Durchsuchen" onClick="getFileBrowser(\\\''.$this->moduleNameLC.'Inputfield_'.$intId.'_ELEMENT-KEY_0_file\\\', \\\''.$this->moduleName.'\\\', \\\'/uploads\\\')" />';
                } else {
