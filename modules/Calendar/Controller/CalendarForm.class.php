...
class CalendarForm extends CalendarLibrary
{
        ...
        if ($objResult !== false) {
            ...
            $queryInputfield = "SELECT field.`id` AS `id`,
                             ...
                             (
                                ...
                                FROM `".DBPREFIX."module_".self::TABLE_PREFIX."_registration_form_field_name` AS `fieldName`
                             ...
                             (
                                ...
                                FROM `".DBPREFIX."module_".self::TABLE_PREFIX."_registration_form_field_name` AS `fieldDefault`
                        ...
                        FROM ".DBPREFIX."module_".self::TABLE_PREFIX."_registration_form_field AS field
    ...
    function copy()
    {
        ...
        if ($objResultOldForm !== false) {
           ...
           $this->triggerEvent(
            ...
            $queryNewForm = "INSERT INTO ".DBPREFIX."module_".self::TABLE_PREFIX."_registration_form
                                  (`status`,`order`,`title`)
                           VALUES ('0',
                                   '99',
            ...
            if ($objResultNewForm === false) {
                ...
                $queryOldFields = "SELECT id,type,required,`order`,`affiliation`
                                     FROM ".DBPREFIX."module_".self::TABLE_PREFIX."_registration_form_field
                ...
                if ($objResultOldFields !== false) {
                    while (!$objResultOldFields->EOF) {
                        ...
                        $queryNewField = "INSERT INTO ".DBPREFIX."module_".self::TABLE_PREFIX."_registration_form_field
                        ...
                        $queryOldNames =  "SELECT `lang_id`,`name`,`default`
                                             FROM ".DBPREFIX."module_".self::TABLE_PREFIX."_registration_form_field_name
                        ...
                        if ($objResultOldNames !== false) {
                            while (!$objResultOldNames->EOF) {
                                ...
                                $queryNewName = "INSERT INTO ".DBPREFIX."module_".self::TABLE_PREFIX."_registration_form_field_name
    ...
    function save($data)
    {
        ...
        if (intval($this->id) == 0) {
            ...
            $query = "INSERT INTO ".DBPREFIX."module_".self::TABLE_PREFIX."_registration_form
                                  (`status`,`order`,`title`)
                           VALUES ('0',
                                   '99',
                                   '".$formTitle."')";
            ...
            $query = "UPDATE ".DBPREFIX."module_".self::TABLE_PREFIX."_registration_form
                         SET `title` =  '".$formTitle."'
                       WHERE id = '".intval($this->id)."'";
    ...
    function saveInputfields(
        ...
        foreach ($data as $fieldId => $fieldValues) {
            ...
            foreach ($fieldValues['formFieldNames'] as $fieldNameValues) {
                ...
                $query = '
                    INSERT INTO
                        `' . DBPREFIX . 'module_' . self::TABLE_PREFIX . '_registration_form_field_name`
                    SET
    ...
    function delete()
    {
        ...
        $query = "DELETE FROM ".DBPREFIX."module_".self::TABLE_PREFIX."_registration_form
                        WHERE id = '".intval($this->id)."'";
