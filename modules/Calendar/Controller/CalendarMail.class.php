...
class CalendarMail extends CalendarLibrary
{
    ...
    function delete()
    {
        ...
        $query = "DELETE FROM ".DBPREFIX."module_".self::TABLE_PREFIX."_mail
    ...
    function setAsDefault()
    {
        ...
        $query = "UPDATE ".DBPREFIX."module_".self::TABLE_PREFIX."_mail
                     SET is_default = '0'
    ...
    function save($data)
    {
        ...
        if (intval($this->id) == 0) {
            ...
            $query = "INSERT INTO ".DBPREFIX."module_".self::TABLE_PREFIX."_mail
