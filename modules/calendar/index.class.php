...
*/
        ...
        if($showForm) {
            ...
            $this->_objTpl->setVariable(array(
                ...
                'TXT_DESCRIPTION'               => $_ARRAYLANG['TXT_CALENDAR_DESCRIPTION'],
                'TXT_TITLE'                     => $_ARRAYLANG['TXT_CALENDAR_TITLE'],
                ...
                'TXT_EVENTPLACE'                => $_ARRAYLANG['TXT_CALENDER_WHEREWHEN'],
                'TXT_CALENDAR_NEW'              => $_ARRAYLANG['TXT_CALENDAR_NEW'],
                ...
                'TXT_CALENDAR_NAME'             => $_ARRAYLANG['TXT_CALENDAR_NAME'],
                'TXT_NOTIFICATION'              => $_ARRAYLANG['TXT_CALENDAR_MAIL_NOTIFICATION'],
