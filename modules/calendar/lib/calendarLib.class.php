...
class calendarLibrary
{
    ...
    function __construct($url)
    {
        ...
        $this->_objTpl = new \Cx\Core\Html\Sigma(ASCMS_MODULE_PATH.'/calendar'.$this->mandateLink.'/template');
...
//        $end_year        = date("Y", $enddate);
        ...
        if ($type == "show") {
            ...
            $ed = new \Cx\Core\Wysiwyg\Wysiwyg('inputComment',$objResultNote->fields['comment']);
            //calender boxes
            $calendarbox = $this->getBoxes($numBoxes, $year, $month, $day);
            //priority
            switch ($objResultNote->fields['priority']) {
