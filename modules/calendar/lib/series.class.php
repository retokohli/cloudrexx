...
{
	var $eventList = array();
	var $eventList_maxsize;
	var $eventList_startdate;
	var $eventList_enddate;
	var $eventList_auth;
	var $eventList_term;
    ...
    function updateMainEvent($id) {
		...
		foreach ($this->eventList as $key => $array) {
			if ($field = array_search($id,$array)) {
    ...
    function _getMainEvents() {
    	...
    	$query = 	"SELECT
					...
					cal.series_status,
					cal.series_type,
    				cal.series_pattern_count,
    				cal.series_pattern_weekday,
    				cal.series_pattern_day,
    				cal.series_pattern_week,
    				cal.series_pattern_month,
    				cal.series_pattern_type,
    				cal.series_pattern_dourance_type,
    				cal.series_pattern_end,
    				cal.series_pattern_begin
