...
class Auction extends auctionLibrary
{
    ...
    */
    function __construct() {
        ...
        $this->_objTpl = new \Cx\Core\Html\Sigma(ASCMS_MODULE_PATH.'/auction/template');
    ...
    */
    function addEntry() {
        ...
        $this->_objTpl->setVariable(array(
            ...
            'ENTRY_DESC'					=> new \Cx\Core\Wysiwyg\Wysiwyg('description', ''),
...
//                    }
                    ...
                    $this->_objTpl->setVariable(array(
                        ...
                        'ENTRY_DESC'					=> new \Cx\Core\Wysiwyg\Wysiwyg('description', $objResult->fields['description']),
                        'ENTRY_END_YEAR'				=> $Options['auctionend']['year'],
                        'ENTRY_END_MONTH'				=> $Options['auctionend']['month'],
                        'ENTRY_END_DAY'					=> $Options['auctionend']['day'],
                        'ENTRY_END_HOUR'				=> $Options['auctionend']['hour'],
