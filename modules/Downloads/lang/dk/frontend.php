...
$_ARRAYLANG['TXT_DOWNLOADS_FILE_SIZE_EXCEEDS_LIMIT'] = "Filen %s blev ikke uploadet, da den er større end de maksimalt tilladte %s bytes!";
$_ARRAYLANG['TXT_DOWNLOADS_FILE_TOO_LARGE'] = "Filen %s blev ikke uploadet, da filen er for stor!";
