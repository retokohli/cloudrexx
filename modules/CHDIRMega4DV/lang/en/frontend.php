...
/**
 * English frontend language
 * @author      Reto Kohli <reto.kohli@comvation.com>
 * @package     cloudrexx
 * @subpackage  module_chdirmega4dv
 */
global $_ARRAYLANG;
$_ARRAYLANG['TXT_MODULE_CHDIRMEGA4DV'] = 'Mega4DV';
$_ARRAYLANG['TXT_MODULE_CHDIRMEGA4DV_DESCRIPTION'] = 'Process and view static HTML content';
$_ARRAYLANG['TXT_MODULE_CHDIRMEGA4DV_ERROR_FILE_MISSING_FORMAT'] = 'Sorry, could not find the file %1$s';
