...
$_ARRAYLANG['TXT_MARKET_SPEZ_FIELDS'] = "Additional fields";
$_ARRAYLANG['TXT_MARKET_PAYPAL'] = "Payment type";
$_ARRAYLANG['TXT_MARKET_PLACEHOLDER_CONTENT'] = "Place holder for content";
$_ARRAYLANG['TXT_MARKET_PLACEHOLDER_TITLE'] = "Place holder for title";
$_ARRAYLANG['TXT_MARKET_SET_MAXDAYS'] = "max. display time (days)";
$_ARRAYLANG['TXT_MARKET_SET_DESCRIPTION'] = "Show category description";
$_ARRAYLANG['TXT_MARKET_SET_PAGING'] = "Number of Advertisements per page";
$_ARRAYLANG['TXT_MARKET_SET_CURRENCY'] = "Currency";
$_ARRAYLANG['TXT_MARKET_SET_ADD_ENTRY_ONLY_COMMUNITY'] = "Only members are allowed to add advertisements (Community module)";
$_ARRAYLANG['TXT_MARKET_SET_ADD_ENTRY'] = "Allow visitors to add advertisements";
$_ARRAYLANG['TXT_MARKET_SET_EDIT_ENTRY'] = "Allow visitors to edit advertisements";
$_ARRAYLANG['TXT_MARKET_SET_INDEXVIEW'] = "Index view";
$_ARRAYLANG['TXT_MARKET_SET_MAXDAYS_ON'] = "Limited display duration";
$_ARRAYLANG['TXT_MARKET_SET_EXP_SEARCH_PRICE'] = "Select fields for extended search for 'Price up to'";
$_ARRAYLANG['TXT_MARKET_ADVERTISER'] = "Advertiser";
$_ARRAYLANG['TXT_MARKET_SET_CODE_MODE'] = "Activate advertisements using a code";
