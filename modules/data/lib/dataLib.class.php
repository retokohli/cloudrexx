    ...
    function getCategoryString($arrCategories, $boolLinked=false)
    {
        ...
        if (count($arrCategories) > 0) {
            ...
            foreach (array_keys($arrCategories) as $intCategoryId) {
                $strCategoryString .= ($boolLinked) ? '<a href="?section=data&amp;cmd=search&amp;category='.$intCategoryId.'" title="'.$arrCategoryNames[$intCategoryId][FRONTEND_LANG_ID]['name'].'">' : '';
