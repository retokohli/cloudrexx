...
./cx Setting add CHDIRTravelLog -group=config -engine=FileSystem data_folder '/travellog/' 2 text ''
./cx Setting add CHDIRTravelLog -group=config -engine=FileSystem pdf_folder '/travellog/pdf/' 3 text ''
