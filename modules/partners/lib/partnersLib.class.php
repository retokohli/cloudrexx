		 ...
		 if ($objResult->RecordCount() > 0) {
            ...
            while (!$objResult->EOF) {
             // echo $intMessageId." ";
				...
				$objLanguageResult = $objDatabase->Execute($selPartnersDetails);
					...
					$arrReturn[$intMessageId]['translation'][$intLanguageId]['status']      	= $objLanguageResult->fields['status'];
					$arrReturn[$intMessageId]['translation'][$intLanguageId]['level'] 	        = htmlentities(stripslashes($objLanguageResult->fields['level']), ENT_QUOTES, CONTREXX_CHARSET);
					$arrReturn[$intMessageId]['translation'][$intLanguageId]['profile'] 	    = htmlentities(stripslashes($objLanguageResult->fields['profile']), ENT_QUOTES, CONTREXX_CHARSET);
					$arrReturn[$intMessageId]['translation'][$intLanguageId]['country'] 	    = htmlentities(stripslashes($objLanguageResult->fields['country']), ENT_QUOTES, CONTREXX_CHARSET);
					$arrReturn[$intMessageId]['translation'][$intLanguageId]['region']   	    = htmlentities(stripslashes($objLanguageResult->fields['region']), ENT_QUOTES, CONTREXX_CHARSET);
					$arrReturn[$intMessageId]['translation'][$intLanguageId]['vertical'] 	    = htmlentities(stripslashes($objLanguageResult->fields['vertical']), ENT_QUOTES, CONTREXX_CHARSET);
					$arrReturn[$intMessageId]['translation'][$intLanguageId]['category'] 	    = htmlentities(stripslashes($objLanguageResult->fields['name']), ENT_QUOTES, CONTREXX_CHARSET);
					$arrReturn[$intMessageId]['translation'][$intLanguageId]['contactname'] 	= htmlentities(stripslashes($objLanguageResult->fields['contactname']), ENT_QUOTES, CONTREXX_CHARSET);
					$arrReturn[$intMessageId]['translation'][$intLanguageId]['email'] 	        = htmlentities(stripslashes($objLanguageResult->fields['email']), ENT_QUOTES, CONTREXX_CHARSET);
					$arrReturn[$intMessageId]['translation'][$intLanguageId]['website'] 	    = htmlentities(stripslashes($objLanguageResult->fields['website']), ENT_QUOTES, CONTREXX_CHARSET);
					$arrReturn[$intMessageId]['translation'][$intLanguageId]['address1'] 	    = htmlentities(stripslashes($objLanguageResult->fields['address1']), ENT_QUOTES, CONTREXX_CHARSET);
					$arrReturn[$intMessageId]['translation'][$intLanguageId]['address2'] 	    = htmlentities(stripslashes($objLanguageResult->fields['address2']), ENT_QUOTES, CONTREXX_CHARSET);
					$arrReturn[$intMessageId]['translation'][$intLanguageId]['city'] 	        = htmlentities(stripslashes($objLanguageResult->fields['city']), ENT_QUOTES, CONTREXX_CHARSET);
					$arrReturn[$intMessageId]['translation'][$intLanguageId]['zipcode'] 	    = htmlentities(stripslashes($objLanguageResult->fields['zipcode']), ENT_QUOTES, CONTREXX_CHARSET);
					$arrReturn[$intMessageId]['translation'][$intLanguageId]['phone'] 	        = htmlentities(stripslashes($objLanguageResult->fields['phone']), ENT_QUOTES, CONTREXX_CHARSET);
					$arrReturn[$intMessageId]['translation'][$intLanguageId]['fax'] 	        = htmlentities(stripslashes($objLanguageResult->fields['fax']), ENT_QUOTES, CONTREXX_CHARSET);
					$arrReturn[$intMessageId]['translation'][$intLanguageId]['reference'] 	    = htmlentities(stripslashes($objLanguageResult->fields['reference']), ENT_QUOTES, CONTREXX_CHARSET);
					$arrReturn[$intMessageId]['translation'][$intLanguageId]['quote'] 	        = htmlentities(stripslashes($objLanguageResult->fields['quote']), ENT_QUOTES, CONTREXX_CHARSET);
                 ...
                 $arrReturn[$intMessageId]['translation'][$intLanguageId]['count'] +=	$objLanguageResult->RecordCount();
				 $objResult->MoveNext();
             ...
             // echo $intMessageId." ";
				...
				$objLanguageResult = $objDatabase->Execute($selPartnersDetails);
					...
					if ( ($intLanguageId == $this->_intLanguageId && !empty($objLanguageResult->fields['subject'])) ||
						 empty($arrReturn[$intMessageId]['subject']) )
					{
						$arrReturn[$intMessageId][$LevelCategoryID]['subject'] = htmlentities(stripslashes($objLanguageResult->fields['subject']), ENT_QUOTES, CONTREXX_CHARSET);
					}
					...
					$arrReturn[$intMessageId][$LevelCategoryID]['translation'][$intLanguageId]['is_active']      	= $objLanguageResult->fields['is_active'];
					$arrReturn[$intMessageId][$LevelCategoryID]['translation'][$intLanguageId]['subject'] 	    = htmlentities(stripslashes($objLanguageResult->fields['subject']), ENT_QUOTES, CONTREXX_CHARSET);
					$arrReturn[$intMessageId][$LevelCategoryID]['translation'][$intLanguageId]['content'] 	    = $objLanguageResult->fields['content'];
					$arrReturn[$intMessageId][$LevelCategoryID]['translation'][$intLanguageId]['status']      	= $objLanguageResult->fields['status'];
					$arrReturn[$intMessageId][$LevelCategoryID]['translation'][$intLanguageId]['level'] 	        = htmlentities(stripslashes($objLanguageResult->fields['level']), ENT_QUOTES, CONTREXX_CHARSET);
					$arrReturn[$intMessageId][$LevelCategoryID]['translation'][$intLanguageId]['profile'] 	    = htmlentities(stripslashes($objLanguageResult->fields['profile']), ENT_QUOTES, CONTREXX_CHARSET);
					$arrReturn[$intMessageId][$LevelCategoryID]['translation'][$intLanguageId]['country'] 	    = htmlentities(stripslashes($objLanguageResult->fields['country']), ENT_QUOTES, CONTREXX_CHARSET);
					$arrReturn[$intMessageId][$LevelCategoryID]['translation'][$intLanguageId]['region']   	    = htmlentities(stripslashes($objLanguageResult->fields['region']), ENT_QUOTES, CONTREXX_CHARSET);
					$arrReturn[$intMessageId][$LevelCategoryID]['translation'][$intLanguageId]['vertical'] 	    = htmlentities(stripslashes($objLanguageResult->fields['vertical']), ENT_QUOTES, CONTREXX_CHARSET);
					$arrReturn[$intMessageId][$LevelCategoryID]['translation'][$intLanguageId]['category'] 	    = htmlentities(stripslashes($objLanguageResult->fields['name']), ENT_QUOTES, CONTREXX_CHARSET);
					$arrReturn[$intMessageId][$LevelCategoryID]['translation'][$intLanguageId]['contactname'] 	= htmlentities(stripslashes($objLanguageResult->fields['contactname']), ENT_QUOTES, CONTREXX_CHARSET);
					$arrReturn[$intMessageId][$LevelCategoryID]['translation'][$intLanguageId]['email'] 	        = htmlentities(stripslashes($objLanguageResult->fields['email']), ENT_QUOTES, CONTREXX_CHARSET);
					$arrReturn[$intMessageId][$LevelCategoryID]['translation'][$intLanguageId]['website'] 	    = htmlentities(stripslashes($objLanguageResult->fields['website']), ENT_QUOTES, CONTREXX_CHARSET);
					$arrReturn[$intMessageId][$LevelCategoryID]['translation'][$intLanguageId]['address1'] 	    = htmlentities(stripslashes($objLanguageResult->fields['address1']), ENT_QUOTES, CONTREXX_CHARSET);
					$arrReturn[$intMessageId][$LevelCategoryID]['translation'][$intLanguageId]['address2'] 	    = htmlentities(stripslashes($objLanguageResult->fields['address2']), ENT_QUOTES, CONTREXX_CHARSET);
					$arrReturn[$intMessageId][$LevelCategoryID]['translation'][$intLanguageId]['city'] 	        = htmlentities(stripslashes($objLanguageResult->fields['city']), ENT_QUOTES, CONTREXX_CHARSET);
					$arrReturn[$intMessageId][$LevelCategoryID]['translation'][$intLanguageId]['zipcode'] 	    = htmlentities(stripslashes($objLanguageResult->fields['zipcode']), ENT_QUOTES, CONTREXX_CHARSET);
					$arrReturn[$intMessageId][$LevelCategoryID]['translation'][$intLanguageId]['phone'] 	        = htmlentities(stripslashes($objLanguageResult->fields['phone']), ENT_QUOTES, CONTREXX_CHARSET);
					$arrReturn[$intMessageId][$LevelCategoryID]['translation'][$intLanguageId]['fax'] 	        = htmlentities(stripslashes($objLanguageResult->fields['fax']), ENT_QUOTES, CONTREXX_CHARSET);
					$arrReturn[$intMessageId][$LevelCategoryID]['translation'][$intLanguageId]['reference'] 	    = htmlentities(stripslashes($objLanguageResult->fields['reference']), ENT_QUOTES, CONTREXX_CHARSET);
					$arrReturn[$intMessageId][$LevelCategoryID]['translation'][$intLanguageId]['quote'] 	        = htmlentities(stripslashes($objLanguageResult->fields['quote']), ENT_QUOTES, CONTREXX_CHARSET);
       				$arrReturn[$intMessageId][$LevelCategoryID]['translation'][$intLanguageId]['image'] 		    = htmlentities(stripslashes($objLanguageResult->fields['image']), ENT_QUOTES, CONTREXX_CHARSET);
		 ...
		 if ($objResult->RecordCount() > 0) {
			...
			while (!$objResult->EOF) {
				...
				$objLanguageResult = $objDatabase->Execute('SELECT	lang_id,
                 ...
                 $arrReturn['count'] +=	$objLanguageResult->RecordCount();
				$objResult->MoveNext();
			}
