    ...
    function activeSurveys() {
        ...
        while(!$objResult->EOF) {
            if($objResult->fields['isActive'] == "1") {
                $activeImage = ASCMS_MODULE_IMAGE_WEB_PATH.'/survey/led_green.gif';
                $activeTitle = '';
            }
            else {
                $activeImage = ASCMS_MODULE_IMAGE_WEB_PATH.'/survey/led_red.gif';
            ...
            if(isset($_POST['submit_survey'])) {
                ...
                if($AnswerQuestCountCheck == 0) {
		           ...
		           question_id='$question_id' ORDER BY id";
                    ...
                    CSRF::header("Location: ".CONTREXX_SCRIPT_PATH."?section=survey&cmd=surveyattend&id=".$idOfSurvey);
                    $this->_objTpl->setVariable(array(
