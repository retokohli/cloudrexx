...
class BlogAdmin extends BlogLibrary {
    ...
    */
    ...
    function insertEntryData($intMessageId)
    {
        ...
        $arrValues = array();
        foreach (array_keys($_POST) as $strKey => $strValue) {
    ...
    function editComment($intCommentId)
    {
        ...
        if ($intCommentId > 0 && $objCommentResult->RecordCount() == 1) {
            ...
            $this->_objTpl->setVariable(array(
                ...
                'COMMENT_CONTENT'       =>  get_wysiwyg_editor('frmEditComment_Content', stripslashes($objCommentResult->fields['comment']), 'news')
            ));
        } else {
