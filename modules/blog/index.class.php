...
//        $intCount             = $this->countEntries();
        ...
        foreach ($arrEntries as $intEntryId => $arrEntryValues) {
            ...
            $this->_objTpl->setVariable(array(
                ...
                'BLOG_ENTRIES_CONTENT'      =>  html_entity_decode($arrEntryValues['translation'][$this->_intLanguageId]['content']),
                'BLOG_ENTRIES_INTRODUCTION' =>  html_entity_decode($this->getIntroductionText($arrEntryValues['translation'][$this->_intLanguageId]['content'])),
