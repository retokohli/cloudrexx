...
//        $intCount             = $this->countEntries();
    ...
    function getVotingBar($intMessageId) {
        ...
        for ($i = 1; $i <= 10; ++$i) {
            $strReturn .= '<a href="#" onclick="javascript:window.location=\'index.php?section=blog&amp;cmd=details&amp;id='.$intMessageId.'&amp;vote='.$i.'" title="'.$_ARRAYLANG['TXT_BLOG_FRONTEND_OVERVIEW_VOTING_DO'].': '.$i.'\';return false">';
