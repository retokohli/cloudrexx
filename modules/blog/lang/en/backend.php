...
$_ARRAYLANG['TXT_BLOG_SETTINGS_RSS_ACTIVATE_HELP'] = "If the system should create a RSS-feed of your blog, you have to activate this option. Thus some files with the pattern <pre>blog_messages_XX.xml<br />blog_comments_XX.xml<br />blog_category_ID_XX.xml</pre> will be created in the folder <pre>feed/</pre>. The placeholder XX stands for the shortform of the language, ID for the unique identifiert of the category.";
