...
$_ARRAYLANG['TXT_BLOG_SETTINGS_COMMENTS_ALLOW_ANONYMOUS_HELP'] = "Permettre également à des visituers qui ne se sont pas enregistrés de faire des commentaires.";
...
$_ARRAYLANG['TXT_BLOG_SETTINGS_RSS_ACTIVATE_HELP'] = "Mettre à disposition un flux RSS de votre blog, qui permette la syndication d'auters sites à votre contenu. Avec cette option, le répertoire  <pre>feed/</pre> est alimenté avec vos articles dans des fichiers de la forme  <pre>blog_messages_XX.xml<br />blog_comments_XX.xml<br />blog_category_ID_XX.xml</pre>, où XX est remplacé par le code langue et ID par l'ID de la catégorie.";
...
$_ARRAYLANG['TXT_BLOG_ENTRY_COMMENTS_EDIT_USER_STATUS_REGISTERED'] = "Utilisateur enregistré";
$_ARRAYLANG['TXT_BLOG_ENTRY_COMMENTS_EDIT_USER_STATUS_UNREGISTERED'] = "Utilisateur non enregistré";
