...
$_ARRAYLANG['TXT_SETTINGS_PROTOCOL_HTTPS_HELP'] = "By default, Contrexx is set to use HTTP as protocol. You have the option to change the setting to use HTTPS (Hypertext Transfer Protocol Secure), a secure protocol that provides authenticated and encrypted communication. If your webserver doesn't support HTTPS, Contrexx will reset this option to default.";
...
$_ARRAYLANG['TXT_CORE_CM_BLOCKS_AVAILABLE'] = 'Available blocks';
$_ARRAYLANG['TXT_CORE_CM_BLOCKS_ASSIGNED'] = 'Assigned blocks';
