...
$_ARRAYLANG['TXT_GUESTBOOK_MODULE_DESCRIPTION'] = "Mit dem Modul Gästebuch können die Besucher der Internetseite eigene Einträge eröffnen. Diese Einträge können kommentiert und jederzeit vom Administrator gelöscht werden. Selbstverständlich können Sie auch eigene Einträge im Gästebuch erstellen.";
...
$_ARRAYLANG['TXT_CALENDAR_MODULE_DESCRIPTION'] = "Mit dem umfangreichen Veranstaltungskalender präsentieren Sie nicht nur die nächsten Anlässe auf Ihrer Website, sondern verwalten gleichzeitig auch die Anmeldungen.";
$_ARRAYLANG['TXT_THEME_LIBRARIES'] = "Bibliotheken";
$_ARRAYLANG['TXT_THEME_LIBRARY'] = "Bibliothek";
$_ARRAYLANG['TXT_DOC_SYS_MODULE_DESCRIPTION'] = "Mit dem Modul Linkverzeichnis können beliebig Informationen wie Bilder, Daten, RSS Feeds kategorisiert und veröffentlicht werden. Die Einträge können durchsucht und optional bewertet werden";
...
$_ARRAYLANG['TXT_FEED_MODULE_DESCRIPTION'] = "Das RSS Feed Verzeichnis kann neuste Nachrichten von externen Seiten anzeigen. Die Newsfeeds werden dabei im CMS zwischengespeichert und nach Ihrer Wahl kategorisiert.";
...
$_ARRAYLANG['TXT_GALLERY_MODULE_DESCRIPTION'] = "In der Bildergalerie können Bilder nach verschiedenen Kategorien strukturiert im Internet zur Verfügung gestellt werden. Die Bilder können von den Internetbesuchern bewertet und kommentiert werden, falls diese Funktion mit einem Klick aktiviert ist.";
...
$_ARRAYLANG['TXT_NEWS_MODULE_DESCRIPTION'] = "Mit dem News-Modul halten Sie Ihre Besucher auf dem Laufenden. Über Kategorisierung und Schlüsselwörter werden die Nachrichten strukturiert und können anschliessend von Ihren Besuchern über die Suchfunktion wieder gefunden werden.";
...
$_ARRAYLANG['TXT_PODCAST_MODULE_DESCRIPTION'] = "Mit dem Modul können kategorisierte Podcast-Verzeichnisse aufgebaut und gepflegt werden. Podcasting bezeichnet das Produzieren und Anbieten von Mediendateien in einem Newsfeed (meistens RSS) über das Internet.";
...
$_ARRAYLANG['TXT_LIVECAM_MODULE_DESCRIPTION'] = "Sie suchen eine Livecam-Lösung? Mit Cloudrexx integrieren Sie Livecam-Übertragungen problemlos Ihre Website. Das Bild wird jede Minute automatisch aktualisiert. Ihre Kunden bleiben stets auf dem neusten Stand.";
$_ARRAYLANG['TXT_MEMBERDIR_MODULE_DESCRIPTION'] = "Das Modul Adressverzeichnis ermöglicht verschiedene Adressen aufzulisten oder andere Daten zu erzeugen.";
...
$_ARRAYLANG['TXT_SURVEY_MODULE_DESCRIPTION'] = "Das Modul Umfragesystem erlaubt es, Umfragen durchzuführen. Damit können Sie Kundenbedürfnisse, Meinungen oder andere Variationen bei Ihren Internetbesuchern abfragen.";
...
$_ARRAYLANG['TXT_U2U_MODULE_DESCRIPTION'] = "Das Modul ermöglicht das Versenden von Nachrichten zwischen Benutzerkontos innerhalb der Mitgliederverwaltung.";
...
$_ARRAYLANG['TXT_KNOWLEDGE_MODULE_DESCRIPTION'] = "Mit diesem Modul kann das Wissen von Redaktoren strukturiert abgelegt, mit Stichworten indexiert und Besuchern zugänglich gemacht werden.";
