...
//            } else
    ...
    /**
     * Get an array with the new component name as the key and the old component name as the assigned value
     *
     * @return array Array with the new and old component names
     */
    public static function getNewComponentNames()
    {
        $components = array(
            'Config' => 'settings',
