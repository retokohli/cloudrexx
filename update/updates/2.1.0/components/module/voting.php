    ...
    try{
        UpdateUtil::table(
            ...
            array(
                ...
                'additional_nickname' => array('type' => 'INT(1)',      'notnull' => true, 'default'     => 0),
                'additional_forename' => array('type' => 'INT(1)',      'notnull' => true, 'default'     => 0),
                'additional_surname'  => array('type' => 'INT(1)',      'notnull' => true, 'default'     => 0),
                'additional_phone'    => array('type' => 'INT(1)',      'notnull' => true, 'default'     => 0),
                'additional_street'   => array('type' => 'INT(1)',      'notnull' => true, 'default'     => 0),
                'additional_zip'      => array('type' => 'INT(1)',      'notnull' => true, 'default'     => 0),
                'additional_city'     => array('type' => 'INT(1)',      'notnull' => true, 'default'     => 0),
                'additional_email'    => array('type' => 'INT(1)',      'notnull' => true, 'default'     => 0),
                'additional_comment'  => array('type' => 'INT(1)',      'notnull' => true, 'default'     => 0),
            )
        );
        UpdateUtil::table(
