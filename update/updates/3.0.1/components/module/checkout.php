...
function _checkoutUpdate()
{
    try {
        ...
        \Cx\Lib\UpdateUtil::sql('
            INSERT IGNORE INTO `'.DBPREFIX.'module_checkout_settings_mails` (`id`, `title`, `content`)
        ...
        \Cx\Lib\UpdateUtil::sql('
            INSERT IGNORE INTO `'.DBPREFIX.'module_checkout_settings_yellowpay` (`id`, `name`, `value`)
        ...
        \Cx\Lib\UpdateUtil::sql('
            INSERT IGNORE INTO `'.DBPREFIX.'module_checkout_transactions` (`id`, `time`, `status`, `invoice_number`, `invoice_currency`, `invoice_amount`, `contact_title`, `contact_forename`, `contact_surname`, `contact_company`, `contact_street`, `contact_postcode`, `contact_place`, `contact_country`, `contact_phone`, `contact_email`)
