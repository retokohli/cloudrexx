        ...
        try {
            ...
            $callback = function($matches) {
                ...
                if (!preg_match('/<!--\s+BEGIN\s+access_social_networks\s+-->.*<!--\s+END\s+access_social_networks\s+-->/ms', $content)) {
                    $content = preg_replace('/\s*(<div[^>]*>|)(\{ACCESS_SIGNUP_MESSAGE\})(<\/div>|)/ms', '<br /><br /><!-- BEGIN access_social_networks --><fieldset><legend>oder Login mit Social Media</legend><!-- BEGIN access_social_networks_facebook -->        <a class="facebook loginbutton" href="[[ACCESS_SOCIALLOGIN_FACEBOOK]]">Facebook</a>        <!-- END access_social_networks_facebook -->        <!-- BEGIN access_social_networks_google -->        <a class="google loginbutton" href="[[ACCESS_SOCIALLOGIN_GOOGLE]]">Google</a>        <!-- END access_social_networks_google -->        <!-- BEGIN access_social_networks_twitter -->        <a class="twitter loginbutton" href="[[ACCESS_SOCIALLOGIN_TWITTER]]">Twitter</a>        <!-- END access_social_networks_twitter -->    </fieldset>    <!-- END access_social_networks -->$1$2$3', $content);
                }
