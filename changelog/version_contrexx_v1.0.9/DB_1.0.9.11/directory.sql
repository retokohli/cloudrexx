...
UPDATE `contrexx_module_directory_settings` SET `setname` = 'spez_field_22' WHERE `contrexx_module_directory_settings`.`setid` =32 LIMIT 1 ;
...
UPDATE `contrexx_module_directory_settings` SET `setdescription` = 'Einträge nach Alphabet sortieren',
`settyp` = '2' WHERE `contrexx_module_directory_settings`.`setid` =35 LIMIT 1 ;