...
function mig_cssf(){ if (MI_IE>=5.5&&FiltersEnabled){fl=1;
...
function stm(t,s){ if (MI_sNav&&isOK){
...
if (!s[25])s[25]=10;
hs=s[22];
if (MI_pSub==20001108){ if (s[14])ab="STYLE='border:"+s[14]+"px solid"+" "+s[15]+"'";
...
if (Count==1){ if (fl){   if (tb.trans==51)tb.trans=parseInt(Math.random()*50);
...
function mig_clay(){ if (!mig_lay()){isOK=0;
