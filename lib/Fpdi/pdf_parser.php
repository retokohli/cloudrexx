...
class pdf_parser
{
    ...
    public function __construct($filename)
    {
        ...
        if (!class_exists('pdf_context')) {
            require_once(ASCMS_LIBRARY_PATH. '/fpdi/pdf_context.php');
        }
            ...
            switch ($filter[1]) {
                ...
                case '/LZWDecode':
                    if (!class_exists('FilterLZW')) {
                        require_once(ASCMS_LIBRARY_PATH. '/fpdi/filters/FilterLZW.php');
                    }
                ...
                case '/ASCII85Decode':
                    if (!class_exists('FilterASCII85')) {
                        require_once(ASCMS_LIBRARY_PATH. '/fpdi/filters/FilterASCII85.php');
                    }
                ...
                case '/ASCIIHexDecode':
                    if (!class_exists('FilterASCIIHexDecode')) {
                        require_once(ASCMS_LIBRARY_PATH. '/fpdi/filters/FilterASCIIHexDecode.php');
                    }
