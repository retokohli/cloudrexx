...
cx.cm = function(target) {
    ...
    jQuery('#publish').click(function() {
        jQuery.post('index.php?cmd=jsondata&object=page&action=update', jQuery('#cm_form').serialize(), function(response){window.location.reload();} );
    });
...
cx.cm.pageLoaded = function(page) {
    ...
    jQuery('#site input[name="page[metarobots]"]').val(page.metarobots);
    ...
    jQuery('#site input[name="page[caching]"]').val(page.caching);
