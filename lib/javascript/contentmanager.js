    ...
    jQuery("#site-tree")
	        ...
	        .bind("loaded.jstree", function (event, data) {
		        ...
		        jQuery('#site-tree li').each(function(index, node) {
                    ...
                    var del = jQuery('<a class="delete">x</a>');
...
cx.cm = function(target) {
    ...
    jQuery('div.wrapper').click(function(event) {
        jQuery(event.target).find('input[name="type"]:radio').click();
    });

    jQuery('div.wrapper input[name="type"]:radio').click(function(event) {
...
cx.cm.loadPage = function(page) {
    ...
    jQuery('#site input[name="type"][value="'+page.type+'"]').click();
