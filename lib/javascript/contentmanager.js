    ...
    jQuery("#site-tree")
	        ...
	        .bind("loaded.jstree", function (event, data) {
		        ...
		        jQuery('#site-tree li').each(function(index, node) {
                    ...
                    jQuery('<option value="active">[[txt_state_active]]</option>').appendTo(sel);
                    jQuery('<option value="hidden">[[txt_state_hidden]]</option>').appendTo(sel);
                    jQuery('<option value="inactive">[[txt_state_inactive]]</option>').appendTo(sel);
