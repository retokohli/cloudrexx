...
var ContrexxJs = function(theOptions) {
     ...
     * @param string adapter Name of JsonAdapter to call
     * @param string method Name of method to call on adapter
     * @param object options (optional) jQuery.ajax() options
     * @return jqXHR jQuery request object
     */
    var ajaxFunc = function(adapter, method, options) {
        var internalOptions = {
            url: cx.variables.get("cadminPath", "contrexx") + "?cmd=jsondata&object=" + adapter + "&act=" + method,
            success: function(data, textStatus, jqXHR) {
                if (options.preSuccess) {
                    options.preSuccess(data, textStatus, jqXHR);
                }
                if (cx.ui && options.showMessage != false) {
            ...
            error: function(jqXHR, textStatus, errorThrown) {
                ...
                if (cx.ui && options.showMessage != false) {
                    cx.ui.messages.add(cx.variables.get("operationFailed", "contrexx/lang"), "warning");
                }
