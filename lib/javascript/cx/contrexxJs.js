...
var ContrexxJs = function(theOptions) {
  ...
  var processQueue = function() {
    ...
    if (loadingQueue.length === 0) //nothing to do
      return;
    if (loadingQueue[0].working) //already processing work, don't do it twice
      return;
  ...
  var ajaxFunc = function(adapter, method, options) {
    var internalOptions = {
            url: cx.variables.get("basePath", "contrexx") + "api/Data/Json/" + adapter + "/" + method,
