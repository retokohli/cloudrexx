...
var ContrexxJs = function(theOptions) {
     ...
     */
    var include = function(files,callback,lazy, initcall) {
    ...
    return {
        ...
        internal: {
            ...
            dependencyInclude: function(files, callback){
                //todo: this loads files one after another.
                //      maybe we can find a sexier approach
                //      that permits loading only dependant
                //      files this way.
                //      => would speed up initializing.
