        ...
        var UI = function() {
            ...
            var Tooltip = function(element) {
                if (typeof(element) == 'undefined') {
                    $('.tooltip-trigger').tooltip({relative: true, position: 'center right', offset: [0, 10]});
                    $('.tooltip-trigger .no-relative').tooltip({relative: false, position: 'center right', offset: [0, 10]});
                } else {
                    if ($(element).hasClass('no-relative')) {
                        console.log('asdf1');
                        $(element).tooltip({relative: false, position: 'center right', offset: [0, 10]});
                    } else {
                        $(element).tooltip({relative: true, position: 'center right', offset: [0, 10]});
                    }
                }
            };
