cx.ready(function() {
    if ($J(".live-search-user-id").length > 0) {
        ...
        var userAddIcon   = "../core/Core/View/Media/icons/icon-user-add.png";
        var userAddAlt    = "Add user";
        var userEditIcon  = "../core/Core/View/Media/icons/icon-user-edit.png";
        var userEditAlt   = "Edit user";
        var userClearIcon = "../core/Core/View/Media/icons/icon-user-clear.png";
