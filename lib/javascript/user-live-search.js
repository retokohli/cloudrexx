cx.ready(function() {
    if ($J(".live-search-user-id").length > 0) {
        var userMinLength     = cx.variables.get("userMinLength",     "user/live-search");
        var userCanCancel     = cx.variables.get("userCanCancel",     "user/live-search");
        var userCanClear      = cx.variables.get("userCanClear",      "user/live-search");
        var txtUserSearch     = cx.variables.get("txtUserSearch",     "user/live-search");
        var txtUserCancel     = cx.variables.get("txtUserCancel",     "user/live-search");
        var txtUserSearchInfo = cx.variables.get("txtUserSearchInfo", "user/live-search");
