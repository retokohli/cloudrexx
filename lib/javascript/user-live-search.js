cx.ready(function() {
    var inputUserId    = $J(".live-search-user-id");
    var inputUserName  = inputUserId.next(".live-search-user-name");
    ...
    inputUserId.replaceWith(function() {
        var replace = 
            replaceInput(this) +
            "<img class=\"live-search-user-icon\" src=\"images/icons/icon-user.png\" alt=\"User icon\" />" +
            "<span class=\"live-search-user-title\">" + cx.variables.get("userTitle", "user/live-search") + "</span>" +
    ...
    $J(inputUserName).replaceWith(function() {
