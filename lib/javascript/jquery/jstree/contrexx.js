    ...
    $("#site-tree")
	        ...
	        .bind("loaded.jstree", function (event, data) {
		        $('#site-tree a').each(function(index, leaf) {
			        $(leaf).click(function() {
				        $.ajax({url : '?cmd=jsondata&id='+this.id, complete : function(response) { 
...
cx.cm = function(target) {
    $(target).load('template/ascms/cm.html', function() {
        $("input.date").datepicker({ dateFormat: 'dd.mm.yy',showOn: "button", buttonImage: "template/ascms/images/calender.png",buttonImageOnly: true },$.datepicker.regional['']);
