jQuery(function() {
    jQuery("#site-tree")
	        ...
	        .bind("loaded.jstree", function (event, data) {
		        jQuery('#site-tree a').each(function(index, leaf) {
			        jQuery(leaf).click(function() {
				        jQuery.ajax({url : '?cmd=jsondata&id='+this.id, complete : function(response) { 
            ...
            .ajaxStart(function(){
                jQuery('#notificationLayer').fadeIn();
            })
            .ajaxStop(function(){
                jQuery('#notificationLayer').fadeOut();
            });
...
cx.cm = function(target) {
    jQuery(target).load('template/ascms/cm.html', function() {
